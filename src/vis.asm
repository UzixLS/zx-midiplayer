...
vis_piano_key_addresses:
    ...
    assert ($-vis_piano_key_addresses) < 256
...
1:  ld a, c                                                                 ; if (note < FIRST || note > last) ret
    ...
    ret nc                                                                  ; ...
    assert LAYOUT_PIANO_KEYS < 128
    rlca                                                                    ; BC = vis_piano_key_addresses[key_number]
    ld h, high vis_piano_key_addresses                                      ; ...
    add low vis_piano_key_addresses                                         ; ...
    ld l, a                                                                 ; ...
    ld c, (hl)                                                              ; ...
    inc l                                                                   ; ...
    ld b, (hl)                                                              ; ...
    bit 7, b                                                                ; if (address & 0x8000) - assume black key
    jp nz, .black                                                           ; ...
.white:
    ld a, ixl                                                               ;
    jp .draw                                                                ;
.black:
    ...
    res 7, b                                                                ;
.draw:
    assert LAYOUT_PIANO_KEYS_ON_LINES == 3
    ld (bc), a                                                              ;
    inc b                                                                   ; pixel_address_down
    ld (bc), a                                                              ;
    inc b                                                                   ; pixel_address_down
    ld (bc), a                                                              ;
    ret                                                                     ;
